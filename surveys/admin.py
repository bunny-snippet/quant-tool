...
class SurveyAttemptAdmin(admin.ModelAdmin):
    list_display = [
        "rid", "prescreener_uid", "provider_profile_uid", "survey", "platform_user", "vendor", "client", "status", "status_source", "initiated_at", "loi_seconds", "initiation_ip",
        "callback_ip", "entry_browser", "entry_device", "is_verified",
    ]
    search_fields = [
        "rid", "prescreener_uid", "provider_profile_uid", "user_id", "platform_user__username", "platform_user__email", "survey__local_id",
...
class ProfileReuseMonthlyCounterAdmin(admin.ModelAdmin):
    list_display = [
        ...
        "allocated_reuses", "first_reuse_allocated", "repeat_reuse_allocated", "updated_at",
    ]
...
class ProfileReuseEventAdmin(admin.ModelAdmin):
    list_display = [
        ...
        "reuse_pool", "country_code", "age_group", "gender", "source_usage_number", "created_at",
    ]
