...
class ClientIntegrationViewSet(PermissionByActionMixin, viewsets.ModelViewSet):
    ...
    def test_connection(self, request, pk=None):
        ...
        if integration.provider_code in {"rfg", "toluna", "track_opinion", "acuity", "unimarket", "zamplia"}:
    ...
    def sync_now(self, request, pk=None):
        ...
        integration = self.get_object()
        if integration.provider_code in {"rfg", "toluna", "track_opinion", "acuity", "unimarket", "zamplia"} and integration.last_test_status != "success":
            return Response(
